...
EMAILJS_INTERVIEW_SERVICE_ID = os.getenv("EMAILJS_INTERVIEW_SERVICE_ID", "")
EMAILJS_INTERVIEW_TEMPLATE_ID = os.getenv("EMAILJS_INTERVIEW_TEMPLATE_ID", "")
EMAILJS_INTERVIEW_PUBLIC_KEY = os.getenv("EMAILJS_INTERVIEW_PUBLIC_KEY", "")

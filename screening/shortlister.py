    ...
    try:
        ...
        with db_session() as db:
            ...
            if result:
                ...
                event_topic = EventTopics.CANDIDATE_SHORTLISTED if result["status"] == "prescreening" else EventTopics.CANDIDATE_REJECTED
...
async def start_event_listener():
    ...
    logger.info("✅ Screening shortlister is now listening for events (auto-screening disabled on upload)")
            ...
            try:
                ...
                with db_session() as db:
                    ...
                    if result:
                        ...
                        next_queue = NEXT_QUEUE if result["status"] == "prescreening" else "candidate_rejected_queue"
